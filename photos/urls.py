...
urlpatterns = [
    ...
    # Google Photos Import (Picker 기반)
    path("import/google", import_job.import_from_google, name="import-google"),
    path(
        "import/google/session/<str:session_id>",
        import_job.get_picker_session_status,
        name="import-google-session-status",
    ),
    path(
        "import/google/confirm",
        import_job.confirm_google_picker_selection,
        name="import-google-confirm",
    ),
    path(
        "import/jobs/<str:job_id>",
        import_job.get_import_job_status,
